// Config
var defaultErrorHeading = 'This form has errors';
var defaultErrorDescription = 'Check below for more detail';
...
function checkSelectors(errors) {
  ...
  $(document).find('input[type="radio"], input[type="checkbox"]').each(function () {
    ...
    var $label = $parent.find('legend').clone().children().remove().end().text();
